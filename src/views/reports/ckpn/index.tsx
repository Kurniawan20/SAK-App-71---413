...
interface CKPNReportProps {
  // You can add props here if needed
}

const CKPNReport: FC<CKPNReportProps> = () => {
  // States
  ...
  useEffect(() => {
    const loadData = () => {
      const templatesData = getReportTemplates().filter(template => template.type === 'CKPN')
      const reportsData = getReportsByType('CKPN')
  ...
  return (
    <Box>
      ...
      {activeTab === 0 && (
        <Card variant='outlined'>
          ...
          <CardContent>
            {reports.length === 0 ? (
              <Alert severity='info'>
                No CKPN reports have been generated yet. Go to the Report Templates tab to generate a new report.
              </Alert>
            ) : (
      ...
      {activeTab === 1 && (
        <Card variant='outlined'>
          <CardHeader title='CKPN Report Templates' />
          <Divider />
          <CardContent>
            ...
            <Box sx={{ mt: 2 }}>
              ...
              {activeStep === 2 && (
                <Box sx={{ textAlign: 'center', py: 4 }}>
                  ...
                  <Typography variant='body1' paragraph>
                    Your CKPN report has been generated and is ready for download.
                  </Typography>
                  <Button
                    variant='contained'
